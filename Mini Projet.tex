...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{edit} 
    \vspace{0.5cm}
    
    \textbf{Figure:} Edit Recipe Page \\
    The admin can edit recipes using this interface.
\end{figure}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{manegecat} 
    \vspace{0.5cm}
    
    \textbf{Figure:} Manage Categories Interface \\
    The admin can manage categories using this interface.
\end{figure}
